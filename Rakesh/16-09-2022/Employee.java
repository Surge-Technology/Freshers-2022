...
class Main{
	...
	static Employee parentMethod() {
		...
		emp.setId("Psc107");
		emp.setEmail("RakeshanandC@surgetechinc.in");
		emp.setName("Rakeshanand C");
		emp.setPhone(755038464);
		
		Address ad = new Address();
		ad.setHouseNo("4/46");
		ad.setStreet(" south street");
		ad.setCity("tuticorin");
		ad.setState("tamilnadu");
		ad.setPincode(628302);
		...
		docs1.setDocumentID("2322 2113 1212 ");
